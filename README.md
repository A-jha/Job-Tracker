...
Project in Action - [Jobster](https://jobster-easy.netlify.app/)
...
- POST /auth/register
- {name:'Avi',email:'avi@gmail.com',password:'secret'}
...
- POST /auth/login
- {email:'avi@gmail.com',password:'secret'}
- sends back the user object with token

###### Update USER

- PATCH /auth/updateUser
- { email:'avi@gmail.com', name:'avi', lastName:'jha', location:'my location' }
- sends back the user object with token
...
- PATCH /auth/updateUser
- { email:'avi@gmail.com', name:'avi', lastName:'smith', location:'my location' }
